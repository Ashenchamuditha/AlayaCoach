      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="pt-4 border-t border-border/50">
            ...
            {goal.coachFeedback ? (
              <div className="rounded-lg bg-amber-50/70 dark:bg-amber-950/25 p-3 border border-amber-200/60 dark:border-amber-900/30 text-sm text-amber-900 dark:text-amber-200/90">
                <p>{goal.coachFeedback}</p>
                <div className="flex items-center gap-4">
                  <Button
                    variant="link"
                    size="sm"
                    className="h-auto p-0 mt-2 text-xs text-amber-700 dark:text-amber-400 underline"
                    onClick={() => {
        ...
        <DialogFooter className="flex-col sm:flex-row gap-2">
          {goal.status === "COMPLETED" ? (
            <Button
              className="w-full sm:flex-1 text-amber-600 dark:text-amber-400 border-amber-200 dark:border-amber-900/50 hover:bg-amber-50 dark:hover:bg-amber-950/30"
              variant="outline"
              onClick={() => {
          ...
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
            ...
            {!chatting ? (
              <>
                ...
                {/* Weekly progress chart moved above tabs */}
                ...
                {/* Tabs switcher for goals and food logs */}
                <div className="mt-8 flex flex-col gap-6">
                  <div className="flex flex-wrap items-center justify-between border-b border-border/50 pb-4 gap-4">
                    <div className="flex bg-muted/40 p-1 rounded-xl border border-border/50 relative shadow-sm">
                      <button
                      ...
                      <button
                        ...
                        className={cn(
                          "relative flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-lg transition-all duration-300",
                          activeTab === "food" ? "text-primary" : "text-muted-foreground hover:text-foreground"
                        )}
                      >
                        {activeTab === "food" && (
                          <motion.div
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2">
                                  ...
                                  {g.createdByCoach && (
                                    <Badge
                                      variant="outline"
                                      className="text-[7px] h-3.5 bg-amber-100 dark:bg-amber-950/40 text-amber-700 dark:text-amber-400 border-amber-200 dark:border-amber-900/50 uppercase font-black tracking-tighter shrink-0"
                                    >
                                      Coach Added
                                    </Badge>
                                  )}
                                ...
                                <div className="flex flex-wrap gap-1 mt-1.5">
                                  ...
                                  {g.coachFeedback && (
                                    <Badge
                                      variant="outline"
                                      className="text-[9px] h-4 py-0 bg-amber-50 dark:bg-amber-950/30 text-amber-700 dark:text-amber-400 border-amber-200 dark:border-amber-900/50 font-bold"
                                    >
                                      Has Feedback
                                    </Badge>
                                  )}
                          ...
                          selectedFoodEntries.map((entry) => (
                            ...
                            >
                              ...
                              <div className="pt-3 mt-1 border-t border-border/50">
                                ...
                                {entry.coachFeedback ? (
                                  <div className="rounded-lg bg-amber-50/70 dark:bg-amber-950/25 p-2.5 border border-amber-200/60 dark:border-amber-900/30 text-xs text-amber-900 dark:text-amber-200/90 flex items-start justify-between gap-2">
                                    <p className="leading-relaxed">{entry.coachFeedback}</p>
                                    <div className="flex items-center gap-2 shrink-0">
                                      <Button
                                        variant="link"
                                        size="sm"
                                        className="h-auto p-0 text-[10px] text-amber-700 dark:text-amber-400 underline"
                                        onClick={() => {
